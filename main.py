...
def main():
    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            # Repeat the click to zoom in multiple times (e.g., 5 times):
            for _ in range(7):
                zoom_in_button.click()
                page.wait_for_timeout(500)  # Optional delay between zooms
            ...
            # output
            #########
            cleaned_search_for = ''.join(e for e in search_for if e.isalnum() or e.isspace())
            business_list.save_to_excel(f"google_maps_data_{cleaned_search_for.replace(' ', '_')}")
